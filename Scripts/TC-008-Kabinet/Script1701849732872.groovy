...
Mobile.tap(findTestObject('Object Repository/Kabinet/android.widget.ImageView'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Kabinet/android.widget.ImageView (1)'), 0)
