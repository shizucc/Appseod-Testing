...
Mobile.tap(findTestObject('Object Repository/Info UKM/Tombol Info UKM'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Info UKM/Halaman Info UKM'), 0)

Mobile.swipe(0, 1500, 0, 1400)
