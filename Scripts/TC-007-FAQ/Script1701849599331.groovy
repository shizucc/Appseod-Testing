...
Mobile.tap(findTestObject('Object Repository/FAQ/android.widget.ImageView (1)'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/FAQ/android.widget.ImageView (2)'), 0)

Mobile.swipe(0, 500, 0, 0)

Mobile.tap(findTestObject('Object Repository/FAQ/android.view.View'), 0)
